"""
Django settings for farmermngt project.
...
SECRET_KEY = 'django-insecure-n0%&nz!@&&d6*#4p!l!kj7&7732#k)9x-o*db#(l$7=(#eunv-'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Make sure your static folder is named 'static'
]
